// use crate::app::component::{Toast, ToastMessage, ToastMessagetype};
...
// Style for each field including sutable animation for animating
// the placeholder
...
pub fn ShowPersonModal(
    ...
    let on_click_delete = move |_| {
        ...
        let _ = spawn_local(async move {
            // we call the answer function_person with the passed in params
        ...
        <div class="flex flex-col w-full h-full z-49 bg-[#222222]/[.06]">
            <div class="flex flex-col w-full h-full z-50 mx-auto items-center align-center">
                <div class=MODAL_STYLE>
                    ...
                    <div class="flex flex-row w-full item-center justify-right mt-3">
