...
use crate::app::components::toast::{ToastMessageType, ToastMessage, Toast};

#[component]
pub fn AddPersonModal(set_if_show_modal: WriteSignal<bool>,
                ...
                spawn_local(async move {
                    ...
                    match add_result {
                        ...
                        Ok(_added_person) => {
                            ...
                            // setting this to true to make this toast
                            // for "new memebr added" appear
    ...
    view! {
        <div class="flex flex-col items-center justify-center min-h-screen">
            ...
            />
            <input type="text" placeholder="Componsation"
                class=INPUT_STYLE
                value= compensation
                on:input = move |event| {
