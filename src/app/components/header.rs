...
pub fn Header() -> impl IntoView {
    ...
    view! {
        <div class="flex mx-auto align-center item-center w-full h-12 pt-8 px-20 top-0 fixed">
...
fn get_style_from_url<'a, 'b>(url: &'a ReadSignal<String>, match_url: &'b str) -> &'b str {
